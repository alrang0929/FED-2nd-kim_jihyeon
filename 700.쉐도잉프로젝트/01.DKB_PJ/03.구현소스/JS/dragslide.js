...
function slideFn(selEl) {
  ...
  mFn.addEvt(dtg, "mouseleave", () => {
    // 드래그 상태값 false로 변경!
    // 하단 컨트롤 mouseenter에서 처리하는
    //dragSts값 처리시 mouseleave에서 처리하는 코드가
    //가장 나중에 처리하게 하려면 해당 코드를 settimeout 함수에 넣는다
