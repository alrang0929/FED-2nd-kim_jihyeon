...
//
//1-2) 리엑트 루트 선택하기: createRoot() 메서드 사용
...
// root1.renderdocument.querySelectorAll(target[0]);
//2) JSX를 사용하지 않는 방법
//-> 넣을 요소를 createElement() 사용
const myele2 = React.createElement("h1", {}, "나는 JSX를 쓰지 않아");
//createElement(요소명,(JS코드 작성), 요소내용)
...
const myele3 = (
  <div>
    <h1>리엑트는 {num1 * num2}번 사용해도 좋다</h1>
    <h1>리엑트는 {num1 === 1000 ? "계속" : "한번만"} 사용해도 좋다</h1>
    <h1>
      리엑트는 {num1 === 1000 ? "계속" : "한번만"} {retFn()}
    </h1>
  </div>
);
...
// 출력형식:
// <li>배우명 : 영화명</li>
// 배열변수.map() 을 사용하자! -> 여기서도 맵쬬잉! 인가??? ㄴㄴ
...
const myEle5 = (
  <React.Fragment>
    ...
    <ul>
        {
        mydata.map( i => 
        <li>{i.name}:{i.movie}:{i.idx == 3 ? "예쁨":"멋짐"}</li>
        )}
        </ul>
  </React.Fragment>
);
...
/***************************************************** 
    ...
    <태그 className="클래스명">
    => 리엑트 버전 16부터 class라고 써도 자동변환하여 표시해주지만
    경고메세지가 뜸
*****************************************************/

// 7. 속성으로 클래스 셋팅하여 사용하기 /////////
const myEle7 = (
    <h1 className="myclass">className 속성으로 클래스를 셋팅한다!
    </h1>
  );
