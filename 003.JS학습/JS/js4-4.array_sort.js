//JS4-4. 배열의 정렬 및 검색 - js4-4.array_sort.js
//나의 함수 불러오기
...
//sort()는 기본 문자로 처리하므로 숫자는 내부함수로 뺴기 연산처리 해야한다!

console.log('숫자배열:',arrNumber);
console.log('숫자배열 오름차순 sort:',arrNumber.sort());
console.log('숫자배열 오름차순 `sort(a,b)=>a-b`:',arrNumber.sort((a,b)=>a-b));
